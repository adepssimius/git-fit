...
date: 2026-08-26
sport: Run
name: Threshold — 4x3min (time-based)
type: intervals
block_week: 12
duration_s: 2880
target_mode: effort
brief: >
  14min up, 4x(3min at 5:25 + 2min easy), 7min steady, 7min down. Any road works — no track needed.
follow: >
...
intent: >
  ...
  The week's single quality session, rewritten from 4x800m to time-based reps so it
  needs no track or measured route. Same threshold stimulus, any road or path.
