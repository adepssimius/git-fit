...
**Rate: ~100 g carb/hr on longer and harder sessions**, achieved by mixing gel brands rather than
sticking to one. That is already in the target band — no change needed, and the earlier open
question about grams-per-gel is closed.

**Electrolytes are dosed high and deliberately so.** The athlete tolerates it without GI distress
and it works. An earlier version of this file flagged "sodium is now zero from plain water" as a
gap — it isn't, because sodium is supplemented separately and generously. Keep doing it.

### The one remaining gap: gel palatability over 24 hours

Flavour fatigue at that duration is near-universal, and it is the single thing the 2024 race can't
tell us about — that day was over in an afternoon. What 2024 *does* prove is that **candy and salty
snacks are tolerated by this athlete**. So plan the handover rather than discovering it at 2am:
gels while they're palatable, then real food. **The timer never changes — only what's on the beep
does.** Find the crossover point at the Big Day and both lap simulations.

## Maurten Bicarb System — where the remaining 7 doses go

**Start with what it does and doesn't do.** Sodium bicarbonate is a blood buffer: it raises
extracellular buffering capacity so working muscle can clear H+ faster. The evidence supports it for
**high-intensity efforts of roughly 1–10 minutes, and for repeated high-intensity efforts**. Its
benefit tapers as reps lengthen and disappears entirely at aerobic intensity.

> **Do NOT save one for race day.** A 30-hour effort run in Zone 1–2 accumulates H+ nowhere near
